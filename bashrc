...
# set SHELL to zsh for remote login
...
# the default python-pip installation path for ubuntu 16.04
...
# OPAM configuration
. /home/yixing/.opam/opam-init/init.sh > /dev/null 2> /dev/null || true

############################ Stable scripts for each OS
if [ "$(uname)" == "Darwin" ]; then
  # bash_completion
